...
const VEHICLE_PRICING = [
  ...
  {
    vehicleType: 'MAHINDRA_JEETO' as VehicleType,
    displayName: 'Mahindra Jeeto',
    baseFare: 150, baseIncludesKm: 2, pricePerKm: 15, minFare: 200,
    capacityKg: 600, capacityDesc: '600 kg — Small load, fast delivery',
    estimatedEta: 10, tcoPerKm: 10.00, surgeHardCap: 1.5,
    timeFreeMinutes: 30, timeChargePerMin: 1.00,
    waitingFreeMinutes: 30, waitingChargePerBlock: 75,
    loadingChargePerHelper: 300, maxHelpers: 1,
    isActive: true,
  },
  {
    vehicleType: 'ASHOK_LEYLAND_DOST' as VehicleType,
    displayName: 'Ashok Leyland Dost',
    baseFare: 220, baseIncludesKm: 2, pricePerKm: 20, minFare: 280,
    capacityKg: 1000, capacityDesc: '1 Ton — Retail goods, moving',
    estimatedEta: 12, tcoPerKm: 16.00, surgeHardCap: 1.5,
    timeFreeMinutes: 30, timeChargePerMin: 1.50,
    waitingFreeMinutes: 30, waitingChargePerBlock: 100,
    loadingChargePerHelper: 400, maxHelpers: 2,
    isActive: true,
  ...
  {
    vehicleType: 'BOLERO_PICKUP' as VehicleType,
    displayName: 'Bolero Pickup',
    baseFare: 270, baseIncludesKm: 2, pricePerKm: 25, minFare: 350,
    capacityKg: 1300, capacityDesc: '1.3 Ton — Factory supplies',
    estimatedEta: 15, tcoPerKm: 19.00, surgeHardCap: 1.5,
    timeFreeMinutes: 40, timeChargePerMin: 1.50,
    waitingFreeMinutes: 40, waitingChargePerBlock: 120,
    loadingChargePerHelper: 500, maxHelpers: 2,
    isActive: true,
  ...
  {
    vehicleType: 'TATA_INTRA' as VehicleType,
    displayName: 'Tata Intra',
    baseFare: 300, baseIncludesKm: 2, pricePerKm: 26, minFare: 380,
    capacityKg: 1500, capacityDesc: '1.5 Ton — Commercial loads',
    estimatedEta: 15, tcoPerKm: 20.00, surgeHardCap: 1.5,
    timeFreeMinutes: 40, timeChargePerMin: 1.50,
    waitingFreeMinutes: 40, waitingChargePerBlock: 120,
    loadingChargePerHelper: 500, maxHelpers: 2,
    isActive: true,
  ...
  {
    vehicleType: 'MINI_OPEN_PICKUP' as VehicleType,
    displayName: 'Mini Open Pickup',
    baseFare: 190, baseIncludesKm: 2, pricePerKm: 18, minFare: 250,
    capacityKg: 750, capacityDesc: '750 kg — Open bed for loose items',
    estimatedEta: 12, tcoPerKm: 15.00, surgeHardCap: 1.5,
    timeFreeMinutes: 30, timeChargePerMin: 1.50,
    waitingFreeMinutes: 30, waitingChargePerBlock: 100,
    loadingChargePerHelper: 400, maxHelpers: 2,
    isActive: true,
  ...
  {
    vehicleType: 'MINI_CLOSED_VAN' as VehicleType,
    displayName: 'Mini Closed Van',
    baseFare: 220, baseIncludesKm: 2, pricePerKm: 20, minFare: 280,
    capacityKg: 750, capacityDesc: '750 kg — Protected from weather',
    estimatedEta: 12, tcoPerKm: 16.00, surgeHardCap: 1.5,
    timeFreeMinutes: 30, timeChargePerMin: 1.50,
    waitingFreeMinutes: 30, waitingChargePerBlock: 100,
    loadingChargePerHelper: 400, maxHelpers: 2,
  ...
  {
    vehicleType: 'LCV_BOX_TRUCK' as VehicleType,
    displayName: 'LCV Box Truck',
    baseFare: 450, baseIncludesKm: 3, pricePerKm: 28, minFare: 550,
    capacityKg: 2500, capacityDesc: '2.5 Ton — Secure box transport',
    estimatedEta: 18, tcoPerKm: 22.00, surgeHardCap: 2.0,
    timeFreeMinutes: 50, timeChargePerMin: 2.00,
    waitingFreeMinutes: 50, waitingChargePerBlock: 130,
    loadingChargePerHelper: 500, maxHelpers: 3,
    isActive: true,
  },
  {
    vehicleType: 'TRUCK_14FT_OPEN' as VehicleType,
    displayName: '14 Ft Open Truck',
    baseFare: 550, baseIncludesKm: 5, pricePerKm: 30, minFare: 700,
    capacityKg: 3500, capacityDesc: '3.5 Ton — Open bed',
    estimatedEta: 20, tcoPerKm: 25.00, surgeHardCap: 2.0,
    timeFreeMinutes: 60, timeChargePerMin: 2.00,
    waitingFreeMinutes: 60, waitingChargePerBlock: 150,
    loadingChargePerHelper: 600, maxHelpers: 3,
    isActive: true,
  ...
  {
    vehicleType: 'TRUCK_14FT_CLOSED' as VehicleType,
    displayName: '14 Ft Closed Truck',
    baseFare: 650, baseIncludesKm: 5, pricePerKm: 32, minFare: 800,
    capacityKg: 3500, capacityDesc: '3.5 Ton — Closed container',
    estimatedEta: 20, tcoPerKm: 27.00, surgeHardCap: 2.0,
    timeFreeMinutes: 60, timeChargePerMin: 2.00,
    waitingFreeMinutes: 60, waitingChargePerBlock: 150,
    loadingChargePerHelper: 600, maxHelpers: 3,
    isActive: true,
  ...
  {
    vehicleType: 'TRUCK_17FT_CLOSED' as VehicleType,
    displayName: '17 Ft Closed Truck',
    baseFare: 850, baseIncludesKm: 5, pricePerKm: 40, minFare: 1000,
    capacityKg: 6500, capacityDesc: '6.5 Ton — Closed container',
    estimatedEta: 25, tcoPerKm: 35.00, surgeHardCap: 2.0,
    timeFreeMinutes: 60, timeChargePerMin: 2.50,
    waitingFreeMinutes: 60, waitingChargePerBlock: 150,
    loadingChargePerHelper: 700, maxHelpers: 4,
    isActive: true,
  ...
  {
    vehicleType: 'TRUCK_19FT' as VehicleType,
    displayName: '19 Ft Truck',
    baseFare: 1100, baseIncludesKm: 5, pricePerKm: 48, minFare: 1400,
    capacityKg: 8000, capacityDesc: '8.0 Ton — Heavy cargo',
    estimatedEta: 28, tcoPerKm: 40.00, surgeHardCap: 2.0,
    timeFreeMinutes: 80, timeChargePerMin: 3.00,
    waitingFreeMinutes: 80, waitingChargePerBlock: 150,
    loadingChargePerHelper: 800, maxHelpers: 4,
    isActive: true,
  },
];
